...
public:
	...
	// The Unix commit date
	static std::int64_t CommitDateSecsSinceEpoch();
	// The ISO8601 author date
	static std::string AuthorDate();
	// The Unix author date
	static std::int64_t AuthorDateSecsSinceEpoch();
	// The commit subject.
